...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("049c436c143ab887d9b0fcd4cb586e0e0956e191806a49203e228924d502bc87782d8ae16c9872675235bf58efa3a1c6edc533868a52a2001f3be0cfd59c893bbc");
        nDefaultPort = 44444;
        nRPCPort = 44445;
        ...
        const char* pszTimestamp = "Aerium launch";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1510410863, vin, vout, 0);
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // aerium test net start with T
