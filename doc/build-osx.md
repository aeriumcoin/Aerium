# Mac OS X Aeriumd Build Instructions
...
* See readme-qt.rst for instructions on building Aerium QT, the
...
## Useful commands
    ...
    ./aeriumd --help  # for a list of command-line options.
    ./aeriumd -daemon # to start the aerium daemon.
    ./aeriumd help    # When the daemon is running, to get a list of RPC commands
